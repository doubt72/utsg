      ...
      module ArmoredFightingVehicles # rubocop:disable Metrics/ModuleLength
        class << self
          ...
          def tanks
            ...
            [
              # Romanian
              ["axm", "R-2", 38, {}], ["axm", "T-3", 42, {}], ["axm", "T-4", 43, {}],
              ["axm", "T-38", 40, {}],

              # Hungarian
              ["axm", "38M Toldi I", 39, {}], ["axm", "42M Toldi II", 42, {}],
              ["axm", "42M Toldi IIA", 43, {}],

              ["chi", "T-26", 38, {}], ["chi", "Vickers 6-Ton", 34, {}],
              ["chi", "M3 Stuart", 42, {}], ["chi", "M4 Sherman", 43, {}],

              ["fra", "Char B1", 35, {}], ["fra", "Char B1 bis", 37, {}], ["fra", "AMR 33", 33, {}],
              ["fra", "AMR 35 (7.5MG)", 36, { sn: 1 }], ["fra", "AMR 35 (13.2MG)", 36, { sn: 2 }],
              ["fra", "AMR 35 ZT2", 36, {}], ["fra", "FCM 36", 38, {}],
              ["fra", "Hotchkiss H35", 36, {}], ["fra", "Hotchkiss H35/39", 39, { sn: 2 }],
              ["fra", "Renault R35", 36, {}], ["fra", "Renault R40", 36, {}],
              ["fra", "AMC 35", 38, {}], ["fra", "Char D2", 36, {}], ["fra", "SOMUA S35", 35, {}],
              ["fra", "M4 Sherman", 43, {}],

              ["ger", "PzKpfw I", 34, {}], ["ger", "PzKpfw II-A/E", 37, {}],
              ["ger", "PzKpfw II-F", 41, {}], ["ger", "PzKpfw II Luchs", 43, {}],
              ["ger", "PzKpfw 35(t)", 38, {}], ["ger", "PzKpfw 38(t) A/D", 39, { sn: 2 }],
              ["ger", "PzKpfw 38(t) E/G", 40, { sn: 2 }], ["ger", "PzKpfw III ('39)", 39, {}],
              ["ger", "PzKpfw III ('40)", 40, {}], ["ger", "PzKpfw III-J", 41, {}],
              ["ger", "PzKpfw III-L", 41, {}], ["ger", "PzKpfw III-N", 42, {}],
              ["ger", "PzKpfw IV-A", 39, {}], ["ger", "PzKpfw IV-B/C", 39, {}],
              ["ger", "PzKpfw IV-D", 39, {}], ["ger", "PzKpfw IV-E", 40, {}],
              ["ger", "PzKpfw IV-F1", 41, {}], ["ger", "PzKpfw IV-F2", 42, {}],
              ["ger", "PzKpfw IV-G", 43, {}], ["ger", "PzKpfw IV-H/J", 43, {}],
              ["ger", "Panther D", 43, {}], ["ger", "Panther A/G", 43, {}],
              ...
              ["uk", "Cruiser Mk I", 38, {}], ["uk", "Cruiser Mk II", 40, {}],
              ["uk", "Cruiser Mk III", 40, {}], ["uk", "Cruiser Mk IV", 40, {}],
              ["uk", "Crusader I", 41, {}], ["uk", "Crusader II", 41, {}],
              ["uk", "Crusader III", 42, {}], ["uk", "Centaur", 44, {}],
              ["uk", "Cromwell", 44, {}], ["uk", "Challenger", 44, {}], ["uk", "Comet", 44, {}],
              ["uk", "Matilda I", 38, {}], ["uk", "Matilda II", 39, {}],
              ["uk", "Valentine I-VII", 40, {}], ["uk", "Valentine IX-X", 43, {}],
              ["uk", "Churchill I-II", 41, {}], ["uk", "Churchill III-IV", 42, {}],
              ["uk", "Churchill V-VI", 43, {}], ["uk", "Churchill VII-VIII", 44, { sn: 1 }],
              ["uk", "M3 Stuart", 41, {}], ["uk", "M22 Locust", 42, {}],
              ["uk", "M24 Chaffee", 44, {}], ["uk", "M3 Lee", 41, {}], ["uk", "M3 Grant", 41, {}],
              ["uk", "M4 Sherman", 42, {}], ["uk", "M4(76) Sherman", 43, { sn: 1 }],
              ["uk", "Sherman Firefly", 43, {}],

              ["usa", "M.-H. CTLS-4", 43, {}], ["usa", "M2A4", 35, {}],
              ["usa", "M3 Stuart", 41, {}], ["usa", "M5 Stuart", 42, {}],
              ["usa", "M24 Chaffee", 44, {}], ["usa", "M3 Lee", 41, {}],
              ...
              ["ussr", "T-26 M39", 39, {}], ["ussr", "T-70", 42, {}],
              ["ussr", "T-34 M40", 40, {}], ["ussr", "T-34 M41", 41, {}],
              ["ussr", "T-34 M42/M43", 42, {}], ["ussr", "T-34-85", 43, {}],
              ["ussr", "T-34-85 M44", 44, {}], ["ussr", "KV-1 M39", 39, {}],
              ["ussr", "KV-1 M40", 40, {}], ["ussr", "KV-1 M41", 41, {}],
              ["ussr", "KV-1 M42", 42, {}], ["ussr", "KV-1S", 42, {}], ["ussr", "KV-2", 40, {}],
              ["ussr", "KV-85", 43, {}], ["ussr", "IS-2", 44, {}],
              ["ussr", "Matilda II", 41, {}], ["ussr", "Valentine", 41, {}],
              ["ussr", "Churchill II", 41, {}], ["ussr", "Churchill III", 42, {}],
              ["ussr", "M3 Stuart", 41, { bd: 4 }], ["ussr", "M3 Grant", 41, { bd: 4 }],
              ["ussr", "M4 Sherman", 43, {}], ["ussr", "M4(76) Sherman", 44, { sn: 1 }],
            ].each do |unit|
              tank = { t: "tank", i: "tank" }
          ...
          def sp_guns
            ...
            [
              ...
              ["ger", "StuG III-B/E", 40, {}], ["ger", "StuG III-F/G", 42, {}],
              ["ger", "StuH 42", 42, {}], ["ger", "StuG IV", 43, {}], ["ger", "SdKfz 166", 42, {}],
              ["ger", "Panzerjäger I", 40, {}], ["ger", "Marder I", 42, {}],
              ["ger", "Marder II", 42, {}], ["ger", "Marder III", 42, {}],
              ["ger", "Marder III-H/M", 43, {}], ["ger", "Nashorn", 42, {}],
              ["ger", "Elefant", 42, {}], ["ger", "Jagdpanzer IV", 43, {}],
              ["ger", "Hetzer", 44, {}], ["ger", "Jagdpanther", 44, {}],
              ["ger", "Jagdtiger", 44, {}],
              ...
              ["usa", "M10", 42, {}], ["usa", "M10A1", 43, {}],
              ["usa", "M18 Hellcat", 43, {}], ["usa", "M8 Scott", 42, {}],
              ["usa", "M36 Jackson", 44, {}],
          ...
          def armored_cars
            ...
            [
              ...
              ["ger", "SdKfz 221", 35, {}], ["ger", "SdKfz 222", 37, {}],
              ["ger", "SdKfz 234/1", 43, {}], ["ger", "SdKfz 234/2", 43, {}],
              ["ger", "SdKfz 234/3", 44, {}], ["ger", "SdKfz 234/4", 44, {}],

              ["ita", "Autoblindo 41", 41, {}],

              ["jap", "Chiyoda AC", 31, {}], ["jap", "Sumida Type 91", 33, { sn: 1 }],

              ["uk", "AEC AC I", 41, {}], ["uk", "AEC AC II", 42, {}],
              ["uk", "AEC AC II CS", 42, {}], ["uk", "Daimler AC", 41, {}],
              ["uk", "Daimler AC CS", 41, {}], ["uk", "Humber AC I", 40, {}],
