        ...
        class << self
          ...
          def weapon_data
            {
              ...
              # Artillery
              "radio_75mm": { fp: 16, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_76mm": { fp: 16, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_85mm": { fp: 20, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_88mm": { fp: 20, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_100mm": { fp: 24, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_105mm": { fp: 24, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_114mm": { fp: 32, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_122mm": { fp: 32, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_140mm": { fp: 40, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_149mm": { fp: 48, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_15cm": { fp: 48, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_152mm": { fp: 48, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_155mm": { fp: 48, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_17cm": { fp: 48, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_183mm": { fp: 64, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_8inch": { fp: 80, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              "radio_21cm": { fp: 80, rng: 99, mv: 0, smk: true, off: true, area: true, fix: 18, sz: 1 },
              # Field Guns
              ...
              "type_92_70mm": { fp: 16, rng: 16, mv: 2, tgt: true, fix: 18, gun: true, smk: true, crw: true, sz: 2, twsz: 2 },
              "type_94_75mm": { fp: 16, rng: 16, mv: 1, tgt: true, fix: 18, gun: true, smk: true, crw: true, sz: 3, twsz: 3 },
              "type_89_15cm": { fp: 40, rng: 24, mv: 1, tgt: true, fix: 18, gun: true, smk: true, crw: true, sz: 3, twsz: 3 },
              "type_92_10cm": { fp: 24, rng: 24, mv: 1, tgt: true, fix: 18, gun: true, smk: true, crw: true, sz: 3, twsz: 3 },
              ...
              "type_94_37mm": { fp: 5, rng: 12, mv: 2, tgt: true, fix: 18, at: true, crw: true, sz: 2, twsz: 2 },
              "type_1_37mm": { fp: 6, rng: 12, mv: 2, tgt: true, fix: 18, at: true, crw: true, sz: 2, twsz: 2 },
              "type_1_47mm": { fp: 12, rng: 16, mv: 1, tgt: true, fix: 18, at: true, crw: true, sz: 3, twsz: 3 },
              "type_90_75mm": { fp: 20, rng: 20, mv: 1, tgt: true, fix: 18, at: true, crw: true, sz: 3, twsz: 3 },
              ...
              "type_90_75mm_t": { fp: 16, rng: 24, tgt: true, fix: 18, gun: true },
              "type_92_10cm_t": { fp: 24, rng: 24, tgt: true, fix: 18, gun: true },
              ...
              "type_90_57mm_t": { fp: 12, rng: 20, tgt: true, fix: 18, at: true },
          ...
          def vehicle_data
            { # rubocop:disable Metric/CollectionLiteralLength
              ...
              "renault_ue": { sz: 2, mv: 4, trn: 1, ctw: true, arm: [0, 0, 0, -1] },
              "lorraine_37l": { sz: 3, mv: 5, trn: 2, ctw: true, arm: [0, 0, 0, -1] },
              ...
              "type_97_te_ke": { sz: 3, mv: 4, wpn: :"type_94_37mm", arm: [1, 0, 0], trt: [1, 1, 1] },
              "type_97_te_ke_mg": { sz: 3, mv: 4, wpn: :"type_92_hmg", arm: [1, 0, 0], trt: [1, 1, 1] },
              "type_95_ha_go": { sz: 3, mv: 6, wpn: :"type_94_37mm", arm: [1, 1, 1], trt: [1, 1, 1] },
              "type_89_i_go": { sz: 3, mv: 4, wpn: :"type_90_57mm_t", arm: [1, 0, 0], trt: [1, 0, 0] },
              "type_97_chi_ha": { sz: 3, mv: 5, wpn: :"type_1_47mm", arm: [2, 1, 1], trt: [2, 1, 1] },
              "type_97_kai": { sz: 4, mv: 4, wpn: :"type_1_47mm", arm: [2, 2, 2], trt: [3, 2, 2] },
              "type_2_ka_mi": { sz: 3, mv: 4, wpn: :"type_1_37mm", amp: true, arm: [1, 0, 0], trt: [0, 0, 0] },
              "type_97_chi_ha_ft": { sz: 3, mv: 5, wpn: :"ft", arm: [2, 1, 1] },
              "type_1_ho_ni_i": { sz: 4, mv: 5, wpn: :"type_90_75mm_t", arm: [2, 2, -1] },
              "type_1_ho_ni_ii": { sz: 4, mv: 5, wpn: :"type_92_10cm_t", arm: [2, 2, -1] },
              "type_1_ho_ni_iii": { sz: 4, mv: 4, wpn: :"type_90_75mm_t", arm: [2, 2, 1] },
              ...
              "type_98_so_da": { sz: 3, mv: 5, trn: 2, ctw: true, arm: [1, 1, 1, -1] },
              ...
              "loyd_carrier": { sz: 3, mv: 6, trn: 2, ctw: true, arm: [0, 0, -1] },
              ...
              "m4a176_sherman": { sz: 5, mv: 5, wpn: :"76mm_m1", arm: [5, 3, 3], trt: [6, 5, 5] },
              "m4105_sherman": { sz: 5, mv: 5, wpn: :"105mm_m4", arm: [4, 3, 3], trt: [5, 4, 4] },
              "m4a3e2_sherman": { sz: 6, mv: 4, wpn: :"75mm_m6", arm: [7, 5, 5], trt: [9, 9, 9] },
              "m4a3e276_sherman": { sz: 6, mv: 4, wpn: :"76mm_m1", arm: [7, 5, 5], trt: [9, 9, 9] },
              ...
              "m3a1_scout_car": { sz: 3, mv: 5, wpn: :"m2_browning", whl: true, trn: 2, ctw: true, rot: true, arm: [1, 1, 1, -1] },
              ...
              "m2_half_track": { sz: 3, mv: 6, wpn: :"m2_browning", trn: 2, ctw: true, arm: [1, 1, 0, -1] },
              ...
              "spa_as_37": { sz: 3, mv: 5, whl: true, trn: 2, ctw: true },
              "spa_viberti_as_42": { sz: 3, mv: 5, whl: true, trn: 2, ctw: true },
              "fiat_634": { sz: 3, mv: 5, whl: true, trn: 3, ctw: true },
              "lancia_3ro": { sz: 4, mv: 5, whl: true, trn: 3, ctw: true },
              "spa_as_37_mg": { sz: 3, mv: 5, wpn: :"breda_m37", whl: true, trn: 2, ctw: true },
              "lancia_3ro_at": { sz: 4, mv: 5, wpn: :"cannone_da_47_32", whl: true, trn: 3, ctw: true },
              "lancia_3ro_mg": { sz: 4, mv: 5, wpn: :"breda_m37", whl: true, trn: 3, ctw: true, rot: true },
              ...
              "harley_davidson_wla": { sz: 3, mv: 6, whl: true, trn: 3 },
