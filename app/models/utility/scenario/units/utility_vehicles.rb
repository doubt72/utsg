        ...
        class << self
          ...
          def trucks
            ...
            [
              ...
              ["fra", "Laffly S20", "truck", 37, {}],
              ["fra", "Citroen U23", "truck", 35, {}],
              ["fra", "Dodge WC-51", "truck", 41, {}],
              ["fra", "Jeep", "car", 41, {}],

              ["ger", "Kettenkrad", "truck", 41, {}],
              ["ger", "Maultier", "truck", 41, {}],
              ["ger", "SdKfz 6", "truck", 39, {}],
              ["ger", "SdKfz 7", "truck", 38, {}],
              ["ger", "SdKfz 8", "truck", 37, {}],
              ["ger", "SdKfz 9", "truck", 39, {}],
              ["ger", "SdKfz 10", "truck", 38, {}],
              ["ger", "SdKfz 11", "truck", 38, {}],
              ["ger", "M.-Benz L3000", "truck", 38, {}],
              ["ger", "Opel Blitz", "truck", 30, {}],
              ["ger", "BMW 325", "car", 36, {}],
              ["ger", "VW Kübelwagen", "car", 40, { sn: 1 }],
              ["ger", "m. E. Pkw", "car", 37, {}],
              ["ger", "s. E. Pkw", "truck", 38, {}],
              ["ger", "le. gl. Lkw", "truck", 37, {}],

              ["ita", "Alfa Romeo 430", "truck", 42, {}],
              ["ita", "Alfa Romeo 500", "truck", 37, {}],
              ["ita", "Alfa Romeo 800", "truck", 40, {}],

              ["uk", "Bedford MW", "truck", 39, {}],
              ["uk", "Bedford OY", "truck", 39, {}],
              ["uk", "Bedford QL", "truck", 41, {}],
              ["uk", "Ford F15", "truck", 39, {}],
              ["uk", "Dodge D60", "truck", 39, {}],
              ["uk", "Chevy C30", "truck", 39, {}],
              ["uk", "Chevy C30 MG", "truck", 39, {}],
              ["uk", "Chevy C30 AT", "truck", 39, {}],
              ["uk", "AEC Mk I Deacon", "truck", 42, { sn: 1 }],
              ["uk", "Dodge WC-51", "truck", 41, {}],
              ["uk", "Jeep", "car", 41, {}], # TODO: arm as needed, especially SAS
              ["uk", "Jeep MG", "car", 41, {}],

              ["usa", "Dodge VC G-505", "truck", 40, { sn: 1 }],
              ["usa", "Dodge WC-51", "truck", 41, {}],
              ["usa", "GMC CCKW", "truck", 41, {}],
              ["usa", "Jeep", "car", 41, {}],
              ["usa", "Jeep .50 MG", "car", 41, {}],
              ["usa", "M6 GMC", "truck", 42, {}],
              ["usa", "GMC DUKW", "truck-amp", 42, {}],

              ["ussr", "GAZ-67", "car", 43, {}],
              ["ussr", "GAZ-AA", "truck", 32, {}],
              ["ussr", "GAZ-AAA", "truck", 36, {}],
              ["ussr", "GAZ-MM", "truck", 36, {}],
              ["ussr", "ZIS-5", "truck", 34, {}],
              ["ussr", "Dodge WC-51", "truck", 42, {}],
              ["ussr", "Studebaker US6", "truck", 41, { sn: 1 }],
              ["ussr", "Jeep", "car", 41, {}],
            ].each do |unit|
              truck = { t: "truck" }
              unit.each_with_index do |v, i|
