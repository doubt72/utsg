    ...
    module Units # rubocop:disable Metrics/ModuleLength
      class << self
        ...
        def half_tracks
          ...
          key = %i[c n y s f r v o]
          [
            ["fra", "Renault UE", 32, 3, 0, 0, 4, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, tr: 1 }],
            ...
            ["ger", "SdKfz 251/1", 39, 3, 8, 8, 5, { r: 1, ha: { f: 1, s: 0, r: 0, t: -1 }, tr: 1 }],
            ...
            ["usa", "M2 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["usa", "M3 Half-track", 41, 3, 6, 8, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["usa", "M3A1 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["uk", "M5 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["ussr", "M5 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["chi", "M5 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["ussr", "M9 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["fra", "M9 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 } }],
            ["usa", "M2 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 1 }],
            ["usa", "LVT-1", 42, 4, 10, 12, 5, { r: 1, amp: 1 }],
            ["usa", "LVT-2", 42, 4, 7, 10, 5, { t: 1, p: 1, amp: 1 }],
            ["usa", "LVT(A)-1", 44, 4, 7, 10, 5, { t: 1, g: 1, ha: { f: 3, s: 0, r: 0 }, ta: { f: 4, s: 3, r: 3 }, amp: 1 }],
            ["usa", "LVT(A)-4", 44, 4, 24, 20, 5, { t: 1, g: 1, ha: { f: 3, s: 0, r: 0 }, ta: { f: 3, s: 2, r: 2, t: -1 }, amp: 1 }],
            ["usa", "LVT-1 Armor", 43, 4, 10, 12, 5, { r: 1, ha: { f: 1, s: 0, r: 0, t: -1 }, amp: 1 }],
            ["usa", "LVT-2 Armor", 43, 4, 7, 10, 5, { t: 1, p: 1, ha: { f: 1, s: 0, r: 0, t: -1 }, amp: 1 }],
