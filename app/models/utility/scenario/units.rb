    ...
    module Units # rubocop:disable Metrics/ModuleLength
      class << self
        ...
        def at_guns
          ...
          key = %i[c n y f r o]
          [
            ["alm", "40mm AT Gun", 36, 10, 12, { tow: 2 }],
        ...
        def tanks
          ...
          [
            ...
            ["fra", "Char B1", 35, 5, 10, 12, 3, { t: 1, p: 1, ha: { f: 3, s: 3, r: 3 }, ta: { f: 3, s: 3, r: 3 }, sg: { f: 20, r: 12 } }],
            ["fra", "Char B1 bis", 37, 5, 12, 12, 3, { t: 1, p: 1, ha: { f: 4, s: 4, r: 4 }, ta: { f: 3, s: 3, r: 3 }, sg: { f: 20, r: 12 } }],
        ...
        def half_tracks
          ...
          key = %i[c n y s f r v o]
          [
            ["fra", "Renault UE", 32, 3, 0, 0, 4, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, tr: 2 }],
            ["fra", "Lorraine 37L", 39, 3, 0, 0, 5, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, tr: 3 }],
            ["ger", "SdKfz 250/1", 41, 3, 8, 8, 6, { r: 1, ha: { f: 1, s: 0, r: 0, t: -1 }, tr: 2 }],
            ...
            ["ger", "SdKfz 251/1", 39, 3, 8, 8, 5, { r: 1, ha: { f: 1, s: 0, r: 0, t: -1 }, tr: 3 }],
            ...
            ["jap", "Type 98 So-Da", 41, 3, 0, 0, 5, { r: 1, ha: { f: 1, s: 1, r: 1, t: -1 }, tr: 3 }],
            ["jap", "Type 100 Te-Re", 40, 3, 0, 0, 5, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, tr: 1 }],
            ["jap", "Type 1 Ho-Ha", 44, 3, 4, 8, 6, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, tr: 3 }],
            ["uk", "Loyd Carrier", 39, 3, 0, 0, 6, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, tr: 2 }],
            ["uk", "Universal Carrier", 40, 3, 3, 6, 7, { r: 1, ha: { f: 0, s: 0, r: 0, t: -1 }, sn: 1, tr: 2 }],
            ...
            ["usa", "M2 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["usa", "M3 Half-track", 41, 3, 6, 8, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["usa", "M3A1 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["uk", "M5 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["ussr", "M5 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["chi", "M5 Half-track", 42, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["ussr", "M9 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["fra", "M9 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
            ["usa", "M2 Half-track", 41, 3, 10, 12, 6, { r: 1, ha: { f: 1, s: 1, r: 0, t: -1 }, tr: 3 }],
        ...
        def trucks
          ...
          [
            ...
            ["alm", "Polski Fiat 621", "truck", 35, 3, 0, 0, 5, { tr: 3 }],
            ["axm", "Horse", "cav", 0, 3, 0, 0, 7, { tr: 3 }],
            ["chi", "Horse", "cav", 0, 3, 0, 0, 7, { tr: 3 }],
            ["fra", "Horse", "cav", 0, 3, 0, 0, 7, { tr: 3 }],
            ["fra", "Laffly S20", "truck", 37, 3, 0, 0, 5, { tr: 3 }],
            ["fra", "Citroen U23", "truck", 35, 4, 0, 0, 5, { tr: 3 }],
            ...
            ["ger", "L3000", "truck", 38, 4, 0, 0, 5, { tr: 3 }],
            ["ger", "Opel Blitz", "truck", 30, 3, 0, 0, 5, { tr: 3 }],
            ["ger", "BMW 325", "car", 36, 2, 0, 0, 5, { tr: 2 }],
            ["ger", "VW Kübelwagen", "car", 40, 2, 0, 0, 5, { sn: 1, tr: 1 }],
            ["ger", "m. E. Pkw", "car", 37, 2, 0, 0, 5, { tr: 2 }],
            ["ger", "s. E. Pkw", "truck", 38, 3, 0, 0, 5, { tr: 3 }],
            ["ger", "le. gl. Lkw", "truck", 37, 4, 0, 0, 5, { tr: 3 }],
            ["ger", "L3000", "truck", 38, 4, 0, 0, 5, { tr: 3 }],
            ["ita", "Alfa Romeo 430", "truck", 42, 4, 0, 0, 5, { tr: 3 }],
            ["ita", "Alfa Romeo 500", "truck", 37, 4, 0, 0, 5, { tr: 3 }],
            ["ita", "Alfa Romeo 800", "truck", 40, 5, 0, 0, 5, { tr: 3 }],
            ["jap", "Horse", "cav", 0, 3, 0, 0, 7, { tr: 3 }],
            ["jap", "Bicycle", "cav-wheel", 30, 3, 0, 0, 4, { w: 1, tr: 3 }],
            ["uk", "Horse", "cav", 0, 3, 0, 0, 7, { tr: 3 }],
            ["uk", "Bedford MW", "truck", 39, 3, 0, 0, 5, { tr: 3 }],
            ["uk", "Bedford OY", "truck", 39, 4, 0, 0, 5, { tr: 3 }],
            ["uk", "Bedford QL", "truck", 41, 4, 0, 0, 5, { tr: 3 }],
            ["uk", "Ford F15", "truck", 39, 3, 0, 0, 5, { tr: 3 }],
            ["uk", "Dodge D60", "truck", 39, 4, 0, 0, 5, { tr: 3 }],
            ["uk", "Dodge WC", "truck", 41, 3, 0, 0, 5, { tr: 3 }],
            ["usa", "H-D WLA", "cav-wheel", 40, 3, 0, 0, 6, { tr: 3 }],
            ["usa", "Dodge VC", "truck", 40, 3, 0, 0, 5, { tr: 3 }],
            ["usa", "Dodge WC", "truck", 41, 3, 0, 0, 5, { tr: 3 }],
            ["ussr", "Dodge WC", "truck", 42, 3, 0, 0, 5, { tr: 3 }],
            ["fra", "Dodge WC", "truck", 41, 3, 0, 0, 5, { tr: 3 }],
            ["uk", "Dodge WC", "truck", 41, 3, 0, 0, 5, { tr: 3 }],
            ["usa", "GMC CCKW", "truck", 41, 4, 0, 0, 5, { tr: 3 }],
            ["ussr", "Studebaker US6", "truck", 41, 4, 0, 0, 5, { sn: 1, tr: 3 }],
            ["usa", "Jeep", "car", 41, 2, 0, 0, 5, { tr: 1 }],
            ["uk", "Jeep", "car", 41, 2, 0, 0, 5, { tr: 1 }], # TODO: arm as needed, especially SAS
            ["ussr", "Jeep", "car", 41, 2, 0, 0, 5, { tr: 1 }],
            ["fra", "Jeep", "car", 41, 2, 0, 0, 5, { tr: 1 }],
            ["ussr", "Jeep", "car", 41, 2, 0, 0, 5, { tr: 1 }],
            ...
            ["ussr", "GAZ-67", "car", 43, 2, 0, 0, 5, { tr: 3 }],
            ["ussr", "GAZ-AA", "truck", 32, 3, 0, 0, 5, { tr: 3 }],
            ["ussr", "GAZ-AAA", "truck", 36, 3, 0, 0, 5, { tr: 3 }],
            ["ussr", "GAZ-MM", "truck", 36, 3, 0, 0, 5, { tr: 3 }],
            ["ussr", "ZIS-5", "truck", 34, 3, 0, 0, 5, { tr: 3 }],
          ].each do |unit|
