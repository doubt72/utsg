    ...
    module Units
      class << self # rubocop:disable Metric/ClassLength
        ...
        def sanitize(name)
          ...
          check = name.gsub(%r{[-\s/.]}, "_").downcase
          puts check unless check =~ /^[a-z0-9_]*$/
        ...
        def machine_guns
          lu = {}
          key = %i[c n sub y f r v o]
          [
            ["ger", "MG 34", "L.MG", 36, 5, 8, 0, { a: 1, r: 1, j: 3 }],
            # ["ger", "MG 44", "L.MG", 42, 8, 8, 0, { a: 1, r: 1, j: 3 }],
            ["ger", "MG 08/15", "H.MG", 17, 10, 12, -1, { r: 1, j: 3 }],
            ["ussr", "DP-27", "L.MG", 28, 4, 6, 0, { a: 1, r: 1, j: 3 }],
            # ["ussr", "SG-43", "M.MG", 43, 5, 10, -2, { r: 1, j: 3 }],
            # ["ussr", "PM M1910", "H.MG", 10, 8, 10, -2, { r: 1, j: 3 }],
            ["ussr", "DShK", "H.MG", 38, 14, 15, -2, { r: 1, j: 3 }],
          ].each do |unit|
            mg = { t: "sw", i: "mg" }
            unit.each_with_index do |v, i|
              mg[key[i]] = v
        ...
        def mortars
          ...
          key = %i[c n sub y f r v o]
          [
            ["ger", "5cm leGrW 36", "L.MTR", 36, 8, 11, 0, { m: 2 }],
            # ["ger", "8cm GrW 34", "M.MTR", 37, 20, 17, -2, { s: 1, m: 3 }],
            ["ger", "kz 8cm GrW 42", "M.MTR", 41, 20, 16, -1, { s: 1, m: 3 }],
            # ["ger", "12cm GrW 42", "H.MTR", 43, 40, 32, 1, { s: 1, m: 4, c: 1 }],
            ["ussr", "RM-38", "L.MTR", 38, 8, 14, 0, { m: 2 }],
            # ["ussr", "82-BM-37", "M.MTR", 37, 20, 24, -2, { s: 1, m: 3 }],
            # ["ussr", "82-PM-41", "M.MTR", 41, 20, 24, -2, { s: 1, m: 3 }],
            ["ussr", "120-PM-38", "H.MTR", 39, 40, 32, 1, { s: 1, m: 4, c: 1 }],
          ].each do |unit|
        ...
        def tanks
          ...
          [
            ...
            # ["ger", "PzKpfw 38(t) A/D", 39, 3, 8, 14, 5, { t: 1, p: 1, ha: { f: 2, s: 1, r: 1 }, ta: { f: 2, s: 1, r: 1 } }],
            # ["ger", "PzKpfw 38(t) E/G", 40, 3, 8, 14, 5, { t: 1, p: 1, ha: { f: 4, s: 1, r: 1 }, ta: { f: 4, s: 1, r: 1 } }],
