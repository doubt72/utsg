...
const testUnitData: { [index: string]: string } = {
  ...
  usmoto: "usa_Harley-Davidson WLA_cav", hcav: "ger_Horse_cav", bcav: "jap_Bicycle_cav", htm: "ger_Kettenkrad_truck",
...
export const mapDebugData: {
  ...
  },
  {
    ...
    y: 5,
    units: [
      { u: testUnitData.ginf, x: 1, y: 1 },
      { u: testUnitData.ginf, x: 3, y: 1 },
      { u: testUnitData.ginf, x: 0, y: 2 },
      { u: testUnitData.ginf, x: 2, y: 3 },
      { u: testUnitData.ginf, x: 4, y: 3 },
      { u: testUnitData.ginf, x: 2, y: 4 },
    ],
    features: [],
    hexes: [
      [{ t: "o" }, { t: "o" }, { t: "o" }, { t: "o" }, { t: "o" }],
