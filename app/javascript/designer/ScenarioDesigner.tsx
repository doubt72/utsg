  ...
  return (
    <div className="main-page">
      ...
      <div className="game-control ml05em mt05em mr05em flex-fill">
        <span className="slim-button" onClick={() => {}}>load</span>
        <span className="slim-button" onClick={() => {}}>save</span>
      ...
      <div className="flex ml05em mt05em">
        <div>
          <div className="main-page-list-tabs">
            <div className="bold main-page-list-tab main-page-list-tab-selected">Scenario</div>
            <div className="bold main-page-list-tab main-page-list-tab-unselected">Map</div>
            <div className="bold main-page-list-tab main-page-list-tab-unselected">Units</div>
          </div>
