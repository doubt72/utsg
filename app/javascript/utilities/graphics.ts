...
export function colorLookup(key: string): string {
  const rc = {
    ...
    counterRed: "#A0A", counterObserved: "#55E", markerYellow: "#EE0", markerYellowText: "#BB0",
...
export function colorBaseLookup(key: string): string {
  return {
    ...
    counterRed: "#E00", counterObserved: "#777", markerYellow: "#FF7", markerYellowText: "#BB0",
...
export function counterObserved(): string { return colorLookup("counterObserved") }
