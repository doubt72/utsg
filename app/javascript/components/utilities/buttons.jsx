...
const CustomCheckbox = (props) => {
  if (props.selected) {
    return <button type="button" className="custom-checkbox custom-checkbox-selected" name="check" onClick={props.onClick}><CircleFill /></button>
  } else {
    return <button type="button" className="custom-checkbox" name="check" onClick={props.onClick}><CircleFill /></button>
  }
}
