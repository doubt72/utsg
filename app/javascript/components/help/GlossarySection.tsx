...
const terms: GlossaryData[] = [
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        perform the <strong>fire</strong> action. Unlike many other hex-and-counter games,
        line-of-sight is blocked by the entire hex if the terrain type or a feature blocks LOS, not
        just the subset of the hex containing the blocking obstacle.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        an <strong>infantry</strong> <strong>unit</strong> that has taken <strong>fire</strong> may
        break, in which case the counter is flipped to the other side, and the unit may be{" "}
        <strong>routed</strong> but may not perform any other <strong>actions</strong>.{" "}
        <strong>Infantry weapons</strong> and <strong>crewed weapons</strong> that roll sufficiently
        poorly when attacking may also break; some of those weapons may be flipped (in which case
        they may not fire), others are destroyed and permanently removed from play. Vehicle weapons
        may also break, but in this case, the broken weapon is marked with a broken marker (or a
        destroyed marker if the weapon is destroyed).
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        a <strong>unit</strong> that has taken <strong>fire</strong> and has been forced to take
        cover but not <strong>broken</strong>.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        <strong>armored</strong> vehicle turrets may jam, in which case they will be unable to turn.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        <strong>fire</strong> from mortars and offboard artillery (and a few other weapons) that may
        affect all <strong>units</strong> in a hex, and will ignore <strong>armor</strong> if an
        armored unit is not <strong>fully armored</strong>.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        <strong>fire</strong> that requires a <strong>targeting</strong> roll and may drift into
        nearby hexes if it misses.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        weapons such as machine guns that may target multiple adjacent hexes in a single{" "}
        <strong>fire</strong> action.
      </>
    ),
  },
  {
