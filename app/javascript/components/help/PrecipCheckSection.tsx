...
export default function PrecipCheckSection() {
  ...
  return (
    <div>
      <p>
        If there is a marker for precipitation with a percentage, the player rolls a single d10, and
        if the number times ten is equal or lower than the percentage chance, the marker is placed
        over the current weather marker and the current weather is considered to be whatever type of
        precipitation the marker designates.  Otherwise the precipitation marker is placed in the
        precipitation space and the current weather is the base weather for the scenario.
      </p>
