...
export default function RushSection() {
  return (
    <div>
      <h1>Rushing</h1>
      <p>
        Rushing is a type of, and the same as{" "}
      ...
      <p>
        Only units that have an &quot;activated&quot; status may rush (unactivated units perform
        regular movement). However, a mix of activated units and unactivated units may rush together
        (all of them will be exhausted, however, see below).
      </p>
      <p>
        Upon completion of a rush, units are marked as exhausted and will lose two movement points
        next turn.
      </p>
      <p>
        Units may not pick up weapons during a rush, though they may drop them if they have
        sufficient movement points to do so. Units may drop smoke at the same movement costs as
        normal movement.
      </p>
      <p>
