  ...
  return (
    <>
      <p>
        ...
        on the side that the player is advancing from. Additionally, units and
        features can only be placed in legal locations for those counters. E.g.,
        vehicles can only be placed in hexes that are passable to vehicles, and
        if they can only be move through a hex&apos;s terrain type along a road,
      ...
      <p>
        Finally, players should be aware of how stacking works when placing
