...
export default function CloseCombatSection({ section }: SectionProps) {
  const one1 = new Unit({
  ...
  return (
    <div>
      ...
      <h3>{section}.2. Finish Close Combat</h3>
      <p>
