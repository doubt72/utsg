  ...
  return (
    <div>
      ...
      <p>
        ...
        More precisely, the intent is to streamline some things to keep things moving for possibly
      ...
      <p>
        This server (including this documentation) is a work-in-progress, Doug is still working on
        it and probably always will be.
      </p>
    </div>
  );
}
