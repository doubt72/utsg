  ...
  const protectedRoutes = [
    {
      ...
      children: [
        ...
        { path: "/debug/stats/units", element: <DebugUnitStats proto={false} /> },
        { path: "/debug/stats/units-p", element: <DebugUnitStats proto={true} /> },
        { path: "/debug/stats/units/:nation", element: <DebugUnitStats proto={false} /> },
        { path: "/debug/stats/units-p/:nation", element: <DebugUnitStats proto={true} /> },
        { path: "/debug/stats/scenarios", element: <DebugScenarioStats proto={false} /> },
