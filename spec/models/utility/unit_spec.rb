        ...
        it "has static definitions" do
          ...
          expect(defs[:chi_m2_4_2inch_mortar]).to be == {
            t: "sw", i: "mortar", c: "chi", n: "M2 4.2inch Mortar", y: 43, f: 24, r: 28, v: 2, o: {
              sn: 3, s: 1, m: 5, c: 1, tow: 2, t: 1, b: 3, e: 1,
            }, s: 2,
          }
    ...
    context "guns" do
      context "allied minors" do
        it "has static definitions" do
          ...
          expect(defs[:alm_bofors_37mm_at]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "alm", n: "Bofors 37mm AT", y: 35, f: 8, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1, sn: 1,
            },
          }
        end
      end
      ...
      context "axis minors" do
        it "has static definitions" do
          expect(defs[:axm_3_7cm_pak_36]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "axm", n: "3.7cm Pak 36", y: 36, f: 6, r: 12, o: {
          ...
          expect(defs[:axm_bofors_37mm_at]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "axm", n: "Bofors 37mm AT", y: 35, f: 8, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1, sn: 1,
            },
          }
        end
      ...
      context "china" do
        it "has static definitions" do
          expect(defs[:chi_37mm_m3]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "chi", n: "37mm M3", y: 42, f: 8, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:chi_45mm_19_k]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "chi", n: "45mm 19-K", y: 34, f: 8, r: 12, o: {
          ...
          expect(defs[:chi_type_30_at]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "chi", n: "Type 30 AT", y: 36, f: 6, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
        end
      ...
      context "finland" do
        it "has static definitions" do
          ...
          expect(defs[:fin_bofors_37mm_at]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "fin", n: "Bofors 37mm AT", y: 35, f: 8, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1, sn: 1,
            },
          }
        end
      ...
      context "france" do
        it "has static definitions" do
          ...
          expect(defs[:fra_47mm_apx]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "fra", n: "47mm APX", y: 39, f: 12, r: 16, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
      ...
      context "german" do
        it "has static definitions" do
          ...
          expect(defs[:ger_2_8cm_spzb_41]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "ger", n: "2.8cm sPzB 41", y: 41, f: 10, r: 8, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ger_3_7cm_pak_36]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "ger", n: "3.7cm Pak 36", y: 36, f: 6, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ger_5cm_pak_38]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ger", n: "5cm Pak 38", y: 40, f: 24, r: 24, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          ...
          expect(defs[:ger_7_5cm_pak_40]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ger", n: "7.5cm Pak 40", y: 42, f: 40, r: 32, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ger_7_5cm_pak_97_38]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ger", n: "7.5cm Pak 97/38", y: 42, f: 12, r: 12, o: {
              sn: 1, tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ger_8_8cm_flak_36]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ger", n: "8.8cm Flak 36", y: 36, f: 40, r: 32, o: {
              tow: 4, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
      ...
      context "italy" do
        it "has static definitions" do
          expect(defs[:ita_cannone_da_47_32]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "ita", n: "Cannone da 47/32", y: 35, f: 6, r: 12, o: {
              sn: 3, tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ita_cannone_da_47_40]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "ita", n: "Cannone da 47/40", y: 38, f: 12, r: 16, o: {
              sn: 3, tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          ...
          expect(defs[:ita_cannone_da_75_46]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ita", n: "Cannone da 75/46", y: 34, f: 24, r: 24, o: {
              sn: 3, tow: 4, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
      ...
      context "japan" do
        it "has static definitions" do
          expect(defs[:jap_37mm_type_1]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "jap", n: "37mm Type 1", y: 41, f: 6, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:jap_37mm_type_94]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "jap", n: "37mm Type 94", y: 36, f: 5, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:jap_47mm_type_1]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "jap", n: "47mm Type 1", y: 42, f: 12, r: 16, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          ...
          expect(defs[:jap_75mm_type_90]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "jap", n: "75mm Type 90", y: 42, f: 20, r: 20, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
        end
      ...
      context "united kingdom" do
        it "has static definitions" do
          expect(defs[:uk_qf_17_pounder]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "uk", n: "QF 17-Pounder", y: 43, f: 40, r: 32, o: {
              tow: 4, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          ...
          expect(defs[:uk_qf_2_pounder]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "uk", n: "QF 2-Pounder", y: 36, f: 8, r: 12, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          ...
          expect(defs[:uk_qf_6pdr_mk_ii]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "uk", n: "QF 6Pdr Mk II", y: 41, f: 16, r: 20, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:uk_qf_6pdr_mk_iv]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "uk", n: "QF 6Pdr Mk IV", y: 41, f: 20, r: 24, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
        end
      ...
      context "united states" do
        it "has static definitions" do
          expect(defs[:usa_37mm_m3]).to be == {
            t: "gun", i: "atgun", v: 2, s: 2, c: "usa", n: "37mm M3", y: 38, f: 8, r: 12, o: {
              tow: 2, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:usa_3inch_m5]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "usa", n: "3inch M5", y: 43, f: 24, r: 24, o: {
              tow: 4, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:usa_57mm_m1]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "usa", n: "57mm M1", y: 42, f: 20, r: 24, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
      ...
      context "soviet union" do
        it "has static definitions" do
          expect(defs[:ussr_100mm_bs_3]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ussr", n: "100mm BS-3", y: 44, f: 64, r: 40, o: {
              tow: 4, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ussr_45mm_19_k]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ussr", n: "45mm 19-K", y: 34, f: 8, r: 12, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ussr_45mm_53_k]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ussr", n: "45mm 53-K", y: 37, f: 8, r: 12, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ussr_45mm_m_42]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ussr", n: "45mm M-42", y: 42, f: 12, r: 16, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ussr_57mm_zis_2]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ussr", n: "57mm ZiS-2", y: 41, f: 24, r: 24, o: {
              tow: 3, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
          expect(defs[:ussr_76mm_f_22]).to be == {
            t: "gun", i: "atgun", v: 1, s: 3, c: "ussr", n: "76mm F-22", y: 37, f: 20, r: 24, o: {
              tow: 4, t: 1, j: 3, f: 18, p: 1, c: 1,
            },
          }
      ...
      context "axis minors" do
        it "has static definitions" do
          expect(defs[:axm_fiat_l3]).to be == {
            t: "spg", c: "axm", n: "Fiat L3", y: 35, s: 3, f: 8, r: 10, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: -1,
              }, k: 1, j: 3, f: 16,
            }, i: "spgmg",
      ...
      context "france" do
        it "has static definitions" do
          ...
          expect(defs[:fra_m10]).to be == {
            t: "spg", c: "fra", n: "M10", y: 43, s: 5, f: 24, r: 24, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 2, r: 2,
              }, ta: {
                f: 4, s: 2, r: 2, t: -1,
      ...
      context "german" do
        it "has static definitions" do
          expect(defs[:ger_elefant]).to be == {
            t: "spg", c: "ger", n: "Elefant", y: 42, s: 8, f: 80, r: 40, v: 4, o: {
              t: 1, p: 1, ha: {
                f: 9, s: 3, r: 3,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_jagdpanther]).to be == {
            t: "spg", c: "ger", n: "Jagdpanther", y: 44, s: 6, f: 80, r: 40, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 6, s: 4, r: 3,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_marder_i]).to be == {
            t: "spg", c: "ger", n: "Marder I", y: 42, s: 3, f: 40, r: 32, v: 4, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_marder_ii]).to be == {
            t: "spg", c: "ger", n: "Marder II", y: 42, s: 3, f: 40, r: 32, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 3, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_marder_iii]).to be == {
            t: "spg", c: "ger", n: "Marder III", y: 42, s: 3, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 4, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ger_marder_iii_h_m]).to be == {
            t: "spg", c: "ger", n: "Marder III-H/M", y: 43, s: 3, f: 40, r: 32, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_nashorn]).to be == {
            t: "spg", c: "ger", n: "Nashorn", y: 42, s: 5, f: 80, r: 40, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 3, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_panzerjager_i]).to be == {
            t: "spg", c: "ger", n: "Panzerjäger I", y: 40, s: 3, f: 10, r: 12, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_sdkfz_166]).to be == {
            t: "spg", c: "ger", n: "SdKfz 166", y: 42, s: 5, f: 48, r: 32, v: 4, o: {
              t: 1, g: 1, ha: {
                f: 7, s: 1, r: 1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ger_stug_iii_a]).to be == {
            t: "spg", c: "ger", n: "StuG III-A", y: 40, s: 4, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 4, s: 1, r: 1,
              }, bd: 3, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ger_stug_iii_b_e]).to be == {
            t: "spg", c: "ger", n: "StuG III-B/E", y: 40, s: 4, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 4, s: 1, r: 1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ger_stug_iii_f_g]).to be == {
            t: "spg", c: "ger", n: "StuG III-F/G", y: 42, s: 4, f: 40, r: 32, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 6, s: 1, r: 1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_stug_iv]).to be == {
            t: "spg", c: "ger", n: "StuG IV", y: 43, s: 4, f: 40, r: 32, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 6, s: 1, r: 1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ger_stuh_42]).to be == {
            t: "spg", c: "ger", n: "StuH 42", y: 42, s: 4, f: 24, r: 32, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 6, s: 1, r: 1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
      ...
      context "italy" do
        it "has static definitions" do
          expect(defs[:ita_l3_33]).to be == {
            t: "spg", c: "ita", n: "L3/33", y: 33, s: 3, f: 4, r: 10, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: -1,
              }, k: 1, j: 4, f: 17,
            }, i: "spgmg",
          ...
          expect(defs[:ita_l3_35]).to be == {
            t: "spg", c: "ita", n: "L3/35", y: 35, s: 3, f: 8, r: 10, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: -1,
              }, k: 1, j: 3, f: 16,
            }, i: "spgmg",
          ...
          expect(defs[:ita_l3_38]).to be == {
            t: "spg", c: "ita", n: "L3/38", y: 38, s: 3, f: 16, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: -1,
              }, k: 1, j: 3, f: 16,
            }, i: "spgmg",
          }
          expect(defs[:ita_semovente_da_47_32]).to be == {
            t: "spg", c: "ita", n: "Semovente da 47/32", y: 42, s: 3, f: 6, r: 12, v: 4, o: {
              t: 1, p: 1, ha: {
                f: 3, s: 1, r: -1,
              }, k: 1, j: 3, f: 18, sn: 4,
            }, i: "spat",
          }
          expect(defs[:ita_semovente_da_75_18]).to be == {
            t: "spg", c: "ita", n: "Semovente da 75/18", y: 42, s: 3, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 3, s: 2, r: 2,
              }, k: 1, j: 3, f: 18, sn: 4,
            }, i: "spg",
      ...
      context "japan" do
        it "has static definitions" do
          expect(defs[:jap_type_1_ho_ni_i]).to be == {
            t: "spg", c: "jap", n: "Type 1 Ho-Ni I", y: 42, s: 4, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 2, s: 2, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:jap_type_1_ho_ni_ii]).to be == {
            t: "spg", c: "jap", n: "Type 1 Ho-Ni II", y: 43, s: 4, f: 24, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 2, s: 2, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:jap_type_1_ho_ni_iii]).to be == {
            t: "spg", c: "jap", n: "Type 1 Ho-Ni III", y: 44, s: 4, f: 20, r: 20, v: 4, o: {
              t: 1, p: 1, ha: {
                f: 2, s: 2, r: 1,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
      ...
      context "united kingdom" do
        it "has static definitions" do
          expect(defs[:uk_churchill_crocodile]).to be == {
            t: "spg", c: "uk", n: "Churchill Crocodile", y: 44, s: 6, f: 16, r: 24, v: 4, o: {
              j: 3, t: 1, p: 1, ha: {
                f: 9, s: 6, r: 4,
              }, ta: {
                f: 9, s: 6, r: 6,
          ...
          expect(defs[:uk_cruiser_mk_i_cs]).to be == {
            t: "spg", c: "uk", n: "Cruiser Mk I CS", y: 38, s: 3, f: 24, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 1, s: 1, r: 1,
              }, ta: {
                f: 1, s: 1, r: 1,
          ...
          expect(defs[:uk_cruiser_mk_ii_cs]).to be == {
            t: "spg", c: "uk", n: "Cruiser Mk II CS", y: 40, s: 3, f: 24, r: 24, v: 4, o: {
              t: 1, g: 1, ha: {
                f: 2, s: 2, r: 2,
              }, ta: {
                f: 2, s: 2, r: 2,
              }, s: 1, u: 1, k: 1, j: 3, f: 18, sn: 1,
            }, i: "spg",
          }
          expect(defs[:uk_crusader_i_cs]).to be == {
            t: "spg", c: "uk", n: "Crusader I CS", y: 41, s: 4, f: 16, r: 24, v: 6, o: {
              t: 1, g: 1, ha: {
                f: 4, s: 4, r: 4,
              }, ta: {
                f: 4, s: 4, r: 4,
          ...
          expect(defs[:uk_crusader_ii_cs]).to be == {
            t: "spg", c: "uk", n: "Crusader II CS", y: 42, s: 4, f: 16, r: 24, v: 6, o: {
              t: 1, g: 1, ha: {
                f: 4, s: 4, r: 4,
              }, ta: {
                f: 4, s: 4, r: 4,
          ...
          expect(defs[:uk_m10_achilles]).to be == {
            t: "spg", c: "uk", n: "M10 Achilles", y: 42, s: 5, f: 24, r: 24, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 2, r: 2,
              }, ta: {
                f: 4, s: 2, r: 2, t: -1,
          ...
          expect(defs[:uk_m10_achilles_c]).to be == {
            t: "spg", c: "uk", n: "M10 Achilles C", y: 43, s: 5, f: 40, r: 32, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 2, r: 2,
              }, ta: {
                f: 4, s: 2, r: 2, t: -1,
          ...
          expect(defs[:uk_matilda_ii_cs]).to be == {
            t: "spg", c: "uk", n: "Matilda II CS", y: 39, s: 5, f: 16, r: 24, v: 4, o: {
              t: 1, g: 1, ha: {
                f: 6, s: 5, r: 4,
              }, ta: {
                f: 5, s: 5, r: 5,
          ...
          expect(defs[:uk_valentine_iii_cs]).to be == {
            t: "spg", c: "uk", n: "Valentine III CS", y: 40, s: 4, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 5, s: 4, r: 4,
              }, ta: {
                f: 5, s: 4, r: 4,
      ...
      context "united states" do
        it "has static definitions" do
          expect(defs[:usa_m10]).to be == {
            t: "spg", c: "usa", n: "M10", y: 42, s: 5, f: 24, r: 24, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 2, r: 2,
              }, ta: {
                f: 4, s: 2, r: 2, t: -1,
          ...
          expect(defs[:usa_m10a1]).to be == {
            t: "spg", c: "usa", n: "M10A1", y: 43, s: 5, f: 24, r: 24, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 2, r: 2,
              }, ta: {
                f: 4, s: 2, r: 2, t: -1,
          ...
          expect(defs[:usa_m18_hellcat]).to be == {
            t: "spg", c: "usa", n: "M18 Hellcat", y: 43, s: 4, f: 32, r: 24, v: 7, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 1, r: 1,
              }, ta: {
                f: 2, s: 1, r: 1, t: -1,
          ...
          expect(defs[:usa_m36_jackson]).to be == {
            t: "spg", c: "usa", n: "M36 Jackson", y: 44, s: 5, f: 40, r: 32, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 4, s: 2, r: 2,
              }, ta: {
                f: 5, s: 3, r: 3, t: -1,
          ...
          expect(defs[:usa_m4_sherman_flame]).to be == {
            t: "spg", c: "usa", n: "M4 Sherman Flame", y: 44, s: 5, f: 24, r: 1, v: 5, o: {
              i: 1, ha: {
                f: 5, s: 3, r: 3,
              }, ta: {
                f: 6, s: 5, r: 5,
              }, e: 1, sn: 3, b: 4, u: 1, k: 1,
            }, i: "spft",
          }
          expect(defs[:usa_m8_scott]).to be == {
            t: "spg", c: "usa", n: "M8 Scott", y: 42, s: 4, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 3, s: 2, r: 2,
              }, ta: {
                f: 3, s: 2, r: 2, t: -1,
      ...
      context "soviet union" do
        it "has static definitions" do
          expect(defs[:ussr_isu_122]).to be == {
            t: "spg", c: "ussr", n: "ISU-122", y: 44, s: 6, f: 80, r: 40, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 8, s: 6, r: 6,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ussr_isu_152]).to be == {
            t: "spg", c: "ussr", n: "ISU-152", y: 43, s: 7, f: 48, r: 32, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 8, s: 6, r: 6,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ussr_su_100]).to be == {
            t: "spg", c: "ussr", n: "SU-100", y: 44, s: 5, f: 80, r: 40, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 5, s: 3, r: 3,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
          ...
          expect(defs[:ussr_su_122]).to be == {
            t: "spg", c: "ussr", n: "SU-122", y: 42, s: 5, f: 32, r: 32, v: 6, o: {
              t: 1, g: 1, ha: {
                f: 3, s: 3, r: 3,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ussr_su_152]).to be == {
            t: "spg", c: "ussr", n: "SU-152", y: 43, s: 6, f: 48, r: 32, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 5, s: 4, r: 3,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ussr_su_76]).to be == {
            t: "spg", c: "ussr", n: "SU-76", y: 42, s: 3, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 3, s: 1, r: 1,
              }, bd: 4, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ussr_su_76m]).to be == {
            t: "spg", c: "ussr", n: "SU-76M", y: 42, s: 3, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 3, s: 1, r: -1,
              }, k: 1, j: 3, f: 18,
            }, i: "spg",
          ...
          expect(defs[:ussr_su_85]).to be == {
            t: "spg", c: "ussr", n: "SU-85", y: 43, s: 5, f: 32, r: 32, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 3, s: 3, r: 3,
              }, k: 1, j: 3, f: 18,
            }, i: "spat",
      ...
      context "france" do
        it "has static definitions" do
          ...
          expect(defs[:fra_amc_schneider_p16]).to be == {
            t: "ac", i: "acav", c: "fra", n: "AMC Schneider P16", y: 28, s: 3, f: 4, r: 12, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 1, r: 1,
              }, ta: {
                f: 1, s: 1, r: 1,
      ...
      context "china" do
        it "has static definitions" do
          expect(defs[:chi_m5_half_track]).to be == {
            t: "ht", i: "ht", c: "chi", n: "M5 Half-track", y: 42, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          }
        end
      end
      ...
      context "france" do
        it "has static definitions" do
          ...
          expect(defs[:fra_m9_half_track]).to be == {
            t: "ht", i: "ht", c: "fra", n: "M9 Half-track", y: 41, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
      ...
      context "german" do
        it "has static definitions" do
          expect(defs[:ger_sdkfz_250_1]).to be == {
            t: "ht", i: "ht", c: "ger", n: "SdKfz 250/1", y: 41, s: 3, f: 5, r: 8, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, tr: 2, trg: 1, k: 1, j: 3, f: 16,
            },
          }
          expect(defs[:ger_sdkfz_250_10]).to be == {
            t: "ht", i: "htat", c: "ger", n: "SdKfz 250/10", y: 41, s: 3, f: 6, r: 12, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:ger_sdkfz_250_11]).to be == {
            t: "ht", i: "htat", c: "ger", n: "SdKfz 250/11", y: 41, s: 3, f: 10, r: 8, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:ger_sdkfz_250_7]).to be == {
            t: "ht", i: "htmtr", c: "ger", n: "SdKfz 250/7", y: 41, s: 3, f: 20, r: 17, v: 6, o: {
              t: 1, m: 3, e: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, b: 3, s: 1,
            },
          ...
          expect(defs[:ger_sdkfz_250_8]).to be == {
            t: "ht", i: "htgun", c: "ger", n: "SdKfz 250/8", y: 41, s: 3, f: 16, r: 24, v: 6, o: {
              t: 1, g: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:ger_sdkfz_250_9]).to be == {
            t: "ht", i: "htat", c: "ger", n: "SdKfz 250/9", y: 41, s: 3, f: 6, r: 12, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:ger_sdkfz_251_1]).to be == {
            t: "ht", i: "ht", c: "ger", n: "SdKfz 251/1", y: 39, s: 3, f: 5, r: 8, v: 5, o: {
              r: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          ...
          expect(defs[:ger_sdkfz_251_10]).to be == {
            t: "ht", i: "htat", c: "ger", n: "SdKfz 251/10", y: 39, s: 3, f: 6, r: 12, v: 5, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:ger_sdkfz_251_9]).to be == {
            t: "ht", i: "htgun", c: "ger", n: "SdKfz 251/9", y: 39, s: 3, f: 16, r: 24, v: 5, o: {
              t: 1, g: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
      ...
      context "japan" do
        it "has static definitions" do
          ...
          expect(defs[:jap_type_1_ho_ha]).to be == {
            t: "ht", i: "ht", c: "jap", n: "Type 1 Ho-Ha", y: 44, s: 3, f: 6, r: 8, v: 6, o: {
              r: 1, ha: {
                f: 0, s: 0, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
      ...
      context "united kingdom" do
        it "has static definitions" do
          ...
          expect(defs[:uk_m5_half_track]).to be == {
            t: "ht", i: "ht", c: "uk", n: "M5 Half-track", y: 42, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          ...
          expect(defs[:uk_u_carrier_2pdr]).to be == {
            t: "ht", i: "htat", c: "uk", n: "U Carrier 2Pdr", y: 41, s: 3, f: 8, r: 12, v: 7, o: {
              t: 1, p: 1, ha: {
                f: 0, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:uk_u_carrier_6pdr]).to be == {
            t: "ht", i: "htat", c: "uk", n: "U Carrier 6Pdr", y: 41, s: 3, f: 16, r: 20, v: 7, o: {
              t: 1, p: 1, ha: {
                f: 0, s: 0, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
      ...
      context "united states" do
        it "has static definitions" do
          expect(defs[:usa_lvt_1]).to be == {
            t: "ht", i: "ht-amp", c: "usa", n: "LVT-1", y: 41, s: 4, f: 20, r: 12, v: 4, o: {
              r: 1, amp: 1, tr: 3, bd: 4, k: 1, j: 3, f: 16,
            },
          }
          expect(defs[:usa_lvt_2]).to be == {
            t: "ht", i: "ht-amp", c: "usa", n: "LVT-2", y: 43, s: 4, f: 20, r: 12, v: 5, o: {
              r: 1, amp: 1, tr: 3, bd: 3, k: 1, j: 3, f: 16,
            },
          }
          expect(defs[:usa_lvt_4]).to be == {
            t: "ht", i: "ht-amp", c: "usa", n: "LVT-4", y: 44, s: 5, f: 20, r: 12, v: 5, o: {
              r: 1, amp: 1, tr: 3, bd: 3, k: 1, j: 3, f: 16,
            },
          }
          expect(defs[:usa_lvta_1]).to be == {
            t: "ht", i: "htat-amp", c: "usa", n: "LVT(A)-1", y: 41, s: 4, f: 8, r: 12, v: 5, o: {
              u: 1, t: 1, p: 1, ha: {
                f: 1, s: 0, r: 0,
              }, ta: {
                f: 4, s: 3, r: 3,
              }, amp: 1, tr: 3, bd: 4, k: 1, j: 3, f: 18,
            },
          }
          expect(defs[:usa_lvta_2]).to be == {
            t: "ht", i: "ht-amp", c: "usa", n: "LVT(A)-2", y: 43, s: 4, f: 20, r: 12, v: 5, o: {
              r: 1, ha: {
                f: 1, s: 0, r: 0, t: -1,
              }, amp: 1, tr: 3, bd: 3, k: 1, j: 3, f: 16,
            },
          }
          expect(defs[:usa_lvta_4]).to be == {
            t: "ht", i: "htgun-amp", c: "usa", n: "LVT(A)-4", y: 44, s: 5, f: 16, r: 24, v: 5, o: {
              u: 1, t: 1, g: 1, ha: {
                f: 1, s: 0, r: 0,
              }, ta: {
                f: 4, s: 3, r: 3,
          ...
          expect(defs[:usa_m2_half_track]).to be == {
            t: "ht", i: "ht", c: "usa", n: "M2 Half-track", y: 41, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          ...
          expect(defs[:usa_m3_gmc]).to be == {
            t: "ht", i: "htgun", c: "usa", n: "M3 GMC", y: 42, s: 3, f: 16, r: 24, v: 6, o: {
              t: 1, g: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:usa_m3_half_track]).to be == {
            t: "ht", i: "ht", c: "usa", n: "M3 Half-track", y: 41, s: 3, f: 8, r: 8, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          ...
          expect(defs[:usa_m3a1_half_track]).to be == {
            t: "ht", i: "ht", c: "usa", n: "M3A1 Half-track", y: 42, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          }
          expect(defs[:usa_t19_hmc]).to be == {
            t: "ht", i: "htgun", c: "usa", n: "T19 HMC", y: 42, s: 3, f: 24, r: 32, v: 6, o: {
              t: 1, g: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
          ...
          expect(defs[:usa_t19_m21_mmc]).to be == {
            t: "ht", i: "htmtr", c: "usa", n: "T19/M21 MMC", y: 42, s: 3, f: 20, r: 17, v: 6, o: {
              t: 1, m: 3, e: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, k: 1, b: 3, s: 1,
            },
      ...
      context "soviet union" do
        it "has static definitions" do
          expect(defs[:ussr_m5_half_track]).to be == {
            t: "ht", i: "ht", c: "ussr", n: "M5 Half-track", y: 42, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          ...
          expect(defs[:ussr_m9_half_track]).to be == {
            t: "ht", i: "ht", c: "ussr", n: "M9 Half-track", y: 41, s: 3, f: 20, r: 12, v: 6, o: {
              r: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, tr: 3, trg: 1, k: 1, j: 3, f: 16,
            },
          ...
          expect(defs[:ussr_t48_gmc]).to be == {
            t: "ht", i: "htat", c: "ussr", n: "T48 GMC", y: 42, s: 3, f: 8, r: 12, v: 6, o: {
              t: 1, p: 1, ha: {
                f: 1, s: 1, r: 0, t: -1,
              }, k: 1, j: 3, f: 18,
            },
