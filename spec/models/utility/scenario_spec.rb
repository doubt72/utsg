...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("002")).to be == "1.0-5cc6c8a04522dc9f6dc3090e00e7ae1b"
      ...
      expect(Utility::Scenario.checksum("011")).to be == "1.0-18d20fcc922542374a5070cb5c1985e6"
      ...
      expect(Utility::Scenario.checksum("411")).to be == "0.2a-33e76265bc2c31db8c282bc076692cef"
