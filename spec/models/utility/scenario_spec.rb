...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("315")).to be == "0.1p-5ea3479fe90b08fda90e941e2c71dcc2"
      ...
      expect(Utility::Scenario.checksum("413")).to be == "0.1p-6ddd79ce02169608d9460a34a279f0dc"
      ...
      expect(Utility::Scenario.checksum("416")).to be == "0.1p-a77f941e8492dc988aaaa8aac58564e9"

      expect(Utility::Scenario.checksum("501")).to be == "1.2-27ecf7b2dab18b930268c7c5c6869fa1"
      expect(Utility::Scenario.checksum("502")).to be == "0.5b-036a3b297825415a5ee8cc4ae9c77769"
