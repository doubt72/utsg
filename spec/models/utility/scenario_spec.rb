...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("207")).to be == "0.1p-1489ef1288070538e57aeb94b3d37c11"
      ...
      expect(Utility::Scenario.checksum("302")).to be == "0.4b-b1581a48794ada5238688c812946b7f8"
      ...
      expect(Utility::Scenario.checksum("609")).to be == "0.1p-ae519d72c7bc5cb33a1e5341a9d5a322"
