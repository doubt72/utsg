...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("004")).to be == "0.3b-3a4df9f7912d14287ca88ea0e8fe22a5"
      ...
      expect(Utility::Scenario.checksum("007")).to be == "1.0-ed36f87879c5490690828060f033b5be"
      ...
      expect(Utility::Scenario.checksum("011")).to be == "1.1-4039b0aeb2118b79fb20509190e50fbf"
      ...
      expect(Utility::Scenario.checksum("301")).to be == "1.1-46f647f3b08fe4f2dec4d1b60cd4b731"
      expect(Utility::Scenario.checksum("302")).to be == "0.3b-9090d2c1f38637878e053596c8a81728"
      ...
      expect(Utility::Scenario.checksum("308")).to be == "1.0-c5d37e0289458d212255eaae44f19eaa"
      ...
      expect(Utility::Scenario.checksum("501")).to be == "1.1-ec5a74461980757010ef82fc8aa114ba"
      ...
      expect(Utility::Scenario.checksum("504")).to be == "0.3b-8e4add8f2536bff11bedeef65321bbac"
      ...
      expect(Utility::Scenario.checksum("510")).to be == "1.0-6a6d037221d79f4fc0370bea90f4f56c"
      ...
      expect(Utility::Scenario.checksum("603")).to be == "1.0-e9afb57eb9de014e41e3a65ce0da42bf"
