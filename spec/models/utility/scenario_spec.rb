...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("106")).to be == "0.4b-a8f7e0af4f1fb0a008c2ec32516d4870"
      ...
      expect(Utility::Scenario.checksum("406")).to be == "0.5b-0876a1969767e832f95c7fb9fef731f2"
