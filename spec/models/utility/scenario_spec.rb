...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 158
      ...
      expect(Utility::Scenario.checksum("204")).to be == "0.4a-3a7bc5b72680a341b9e268569d2481f8"
      ...
      expect(Utility::Scenario.checksum("214")).to be == "0.1p-7cb2c6cd50a1645773e64a906c3d3c64"

      expect(Utility::Scenario.checksum("216")).to be == "0.1p-ec47bede0a68773209cdaba827dfd545"
      ...
      expect(Utility::Scenario.checksum("521")).to be == "0.1p-9ae84f007e2adac59d1660741526fdf4"
