...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("216")).to be == "0.1p-689abcdc666beb96be6d5295b931b08f"
      ...
      expect(Utility::Scenario.checksum("523")).to be == "0.1p-92644e0e54ce904b9d2554d0f35b2d0f"
