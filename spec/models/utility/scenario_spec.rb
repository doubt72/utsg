...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("001")).to be == "1.0-4b004374eef525d1314de17e5b840ecb"
      ...
      expect(Utility::Scenario.checksum("101")).to be == "0.1p-617513c498ca13a187f795e77f615622"
      ...
      expect(Utility::Scenario.checksum("401")).to be == "0.1p-8e63689e0ae18546e05e0c8ff6fa6d1a"
