...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("203")).to be == "0.3b-04cba8f06e9ede0931c128c76be05110"
      ...
      expect(Utility::Scenario.checksum("304")).to be == "0.3b-3019efdd75bd34b573274bd0074ab8ff"
      ...
      expect(Utility::Scenario.checksum("406")).to be == "0.4b-ad19b1af2292be84b88f4395abebd5b2"
      ...
      expect(Utility::Scenario.checksum("604")).to be == "0.3a-a4b404c1f7a039f684efe4a172679054"
