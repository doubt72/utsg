...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 106
      ...
      expect(Utility::Scenario.checksum("104")).to be == "0.3b-3e08af84c8bb9f10ffa0fcf50baaf20c"
      ...
      expect(Utility::Scenario.checksum("305")).to be == "0.4b-d7e02bfd54438bda0625328b027aa1d7"
      ...
      expect(Utility::Scenario.checksum("404")).to be == "0.3b-d50e8dc037414c1067e4e33b79af23c5"
      ...
      expect(Utility::Scenario.checksum("502")).to be == "0.3b-98474993b62e18d201c28407fc513798"
      ...
      expect(Utility::Scenario.checksum("602")).to be == "1.0-122289b57a4c4978db87822636e96f54"
      ...
      expect(Utility::Scenario.checksum("613")).to be == "0.1p-8935afac2d182002dd90e9c70c79680d"
    end
  end
end
