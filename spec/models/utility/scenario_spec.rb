...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("103")).to be == "0.3b-d5e83f2bb158c35ce5d6dad8f88f86e0"
      ...
      expect(Utility::Scenario.checksum("313")).to be == "0.1p-bb9c97c02c988ae02a7b3f414a488f3a"
