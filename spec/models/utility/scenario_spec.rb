...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 145
      ...
      expect(Utility::Scenario.checksum("010")).to be == "0.3b-0fdbdd0b0ac89733e7ce3757b179ceea"
      ...
      expect(Utility::Scenario.checksum("025")).to be == "0.1p-deddec23c1af33ae13e295301362193a"
      ...
      expect(Utility::Scenario.checksum("033")).to be == "0.1p-b33ffb74fc96ff7a3bdce2bffd870bb2"
      expect(Utility::Scenario.checksum("034")).to be == "0.1p-365a0855cec368d34c9475f5631de49c"
      expect(Utility::Scenario.checksum("035")).to be == "0.1p-b9cb4c16a792186fbfd6147f69efa836"
      expect(Utility::Scenario.checksum("036")).to be == "0.1p-1ae949168796a5f726d3faef8c116c58"
      expect(Utility::Scenario.checksum("037")).to be == "0.1p-b80f5f8c2725d44c6310364e7b7ad451"
      ...
      expect(Utility::Scenario.checksum("103")).to be == "1.2-b60dd2838f329e75d637047b417b8bd0"
      ...
      expect(Utility::Scenario.checksum("107")).to be == "1.0-db9b83be737d0dbb4c3bd3b222f12274"
      ...
      expect(Utility::Scenario.checksum("204")).to be == "0.4a-2a65349abcb618292432f883c70c500d"
      ...
      expect(Utility::Scenario.checksum("305")).to be == "1.0-202f8e3632daaa972c4bede7ae89420e"
      expect(Utility::Scenario.checksum("306")).to be == "0.4b-f112598b447b88f1d3f2fae5904780ae"
      expect(Utility::Scenario.checksum("307")).to be == "0.4b-be6fe4a7866cdf473ef2dd0c58b7a258"
      ...
      expect(Utility::Scenario.checksum("317")).to be == "0.1p-a4313153c0e5cdf988651ffdf244e080"
      expect(Utility::Scenario.checksum("318")).to be == "0.1p-a7617f0cb0fec8198a81e469d2ff2780"
      ...
      expect(Utility::Scenario.checksum("403")).to be == "1.0-f266762b4effe3bf6b7ee8474c3018ec"
      ...
      expect(Utility::Scenario.checksum("406")).to be == "1.2-06e3c044b1171514633090c865c733b1"
      ...
      expect(Utility::Scenario.checksum("417")).to be == "0.1p-8a39b7df459999dadf84ffc5e8d31602"
      ...
      expect(Utility::Scenario.checksum("424")).to be == "0.1p-feb229e9188313c86d758e96bfef61c7"
      ...
      expect(Utility::Scenario.checksum("504")).to be == "0.5b-7b095bf36f065d2b1ebeafcac95000db"
      ...
      expect(Utility::Scenario.checksum("508")).to be == "1.1-86f4b3e2d1846bb267b89ffb599c13dd"
