...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 105

      # If any of these change, scenario MUST to be updated with a new version,
      # then update test with new version/checksum
      expect(Utility::Scenario.checksum("000")).to be == "1.1-97249ae6c58282a48d06f034b01f1a7e"
      ...
      expect(Utility::Scenario.checksum("004")).to be == "1.0-b39555980516ce152268ceb11f88d693"
      ...
      expect(Utility::Scenario.checksum("016")).to be == "0.5p-a8db51b298d95f1a517ab46f948eee43"
      expect(Utility::Scenario.checksum("017")).to be == "0.1p-8e970017b30986206f629ed225e796f1"
      expect(Utility::Scenario.checksum("018")).to be == "0.1p-54c2d01ca9762c25345e89eb86061286"
      expect(Utility::Scenario.checksum("019")).to be == "0.1p-ee2d8eda7dcd6219bd1be08176538582"
      expect(Utility::Scenario.checksum("020")).to be == "0.1p-ac7bf05afb0b99b0bdd17490621a5df0"

      expect(Utility::Scenario.checksum("022")).to be == "0.1p-e29df2fb4131edb7bd33236f43034e30"
      expect(Utility::Scenario.checksum("023")).to be == "0.4p-f2a23aa247adb63553fbb22cde3181ee"

      expect(Utility::Scenario.checksum("026")).to be == "0.1a-67d24d02ce7c8d79a2246c9d63684288"

      expect(Utility::Scenario.checksum("030")).to be == "0.1p-a42e15ab24db636a1ceb91e13f03bdf9"
      ...
      expect(Utility::Scenario.checksum("103")).to be == "1.0-fc4ea4d02d1909371badffa5febfe88e"
      expect(Utility::Scenario.checksum("104")).to be == "0.2a-7c1078ef7713ca69d7dfa7c14d753ae8"
      ...
      expect(Utility::Scenario.checksum("111")).to be == "0.1p-8e89a036d3cb0907737a3123c65c467f"
      ...
      expect(Utility::Scenario.checksum("114")).to be == "0.1p-8c1c0f2fca855a66bd7e671108e0d826"
      ...
      expect(Utility::Scenario.checksum("403")).to be == "0.4b-ab4333b6e5c0b83c93a3489d752fc296"
      ...
      expect(Utility::Scenario.checksum("406")).to be == "1.0-e7304d0dfdf3706cb96d0e1748f41e8a"
      ...
      expect(Utility::Scenario.checksum("414")).to be == "0.1p-b31c9f770f2766b82c0e50514e68fc7c"
      ...
      expect(Utility::Scenario.checksum("502")).to be == "0.3b-71f721b28d2cf92698fa597114393500"
      ...
      expect(Utility::Scenario.checksum("513")).to be == "0.1p-6daaad8e908f02f09aeac43f52a1394b"
      ...
      expect(Utility::Scenario.checksum("602")).to be == "0.3b-3b85a6bd17d870e6ff0235862e147537"
      expect(Utility::Scenario.checksum("603")).to be == "1.3-184b435e7200f65f45c8f8e1abe68bb8"
      expect(Utility::Scenario.checksum("604")).to be == "1.0-cc1b5ce97e787738e3aff13d9b2b18c4"
      ...
      expect(Utility::Scenario.checksum("609")).to be == "0.1p-0d02e1a824143c977e07b1d2b3a7cbfb"
      expect(Utility::Scenario.checksum("610")).to be == "0.1p-da13b9cdf00083a02126b20858e66a1a"
      expect(Utility::Scenario.checksum("611")).to be == "0.1p-99edc890366a8f15cc88f2229d57d209"
      expect(Utility::Scenario.checksum("612")).to be == "0.1p-1b9a71b67d5e1558789bb3b4a174ee24"
    end
  end
end
