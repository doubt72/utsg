...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 149
      ...
      expect(Utility::Scenario.checksum("429")).to be == "0.1p-fb651f20d572221b28cd527e39a28c91"
      ...
      expect(Utility::Scenario.checksum("504")).to be == "0.6b-8a1effc9fb14cb471f51ffcafb7c4b40"
