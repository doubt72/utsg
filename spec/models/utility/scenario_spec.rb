...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("006")).to be == "0.2b-679ac94340e02d6a1ed3dac8e4d0a424"
      ...
      expect(Utility::Scenario.checksum("203")).to be == "0.2b-d4b99694e5fdd4ba823924f6356e1d7f"
      ...
      expect(Utility::Scenario.checksum("401")).to be == "1.2-865924ba91c5cd393af645d9ffef499a"
      ...
      expect(Utility::Scenario.checksum("406")).to be == "0.3a-bd92d2a0a64daa487c87ec75a7cc9450"
      ...
      expect(Utility::Scenario.checksum("503")).to be == "1.1-af9dba349d135249dce035c58d50c701"
      ...
      expect(Utility::Scenario.checksum("601")).to be == "1.1-ec3d5b499c5246eabd6622c152ed85af"
      expect(Utility::Scenario.checksum("602")).to be == "0.2a-5794b16e30d19385de4e75b5ce31a3e0"
      expect(Utility::Scenario.checksum("603")).to be == "1.2-ef4ce827c640e8c14c8f1965297382de"
