...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(Utility::Scenario.checksum("502")).to be == "0.3b-94b03e2b0fadf8b8b08cd87864167484"
      ...
      expect(Utility::Scenario.checksum("512")).to be == "1.0-6cedb0c2ce24ad83159cea33691cf4b3"
