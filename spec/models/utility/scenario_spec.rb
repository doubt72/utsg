...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 131
      ...
      expect(Utility::Scenario.checksum("107")).to be == "0.3b-40d6177eb8368496577b0bb5420ef1fc"
      ...
      expect(Utility::Scenario.checksum("305")).to be == "1.0-63a61374205b62418fd171c60956ce1a"
      ...
      expect(Utility::Scenario.checksum("405")).to be == "0.3b-4e25a0e05d0345f00e3e770db909619f"
