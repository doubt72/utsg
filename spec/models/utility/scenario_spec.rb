...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 99
      ...
      # expect(Utility::Scenario.checksum("016")).to be == "0.4a-2b01aed8df29a7b831adc14bc417c124"
      ...
      expect(Utility::Scenario.checksum("023")).to be == "0.4a-5dc619e8b5ce301cf0180f7222ac686a"
