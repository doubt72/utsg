...
RSpec.describe Utility::Scenario do
  ...
  context "checksum versioning" do
    it "has correct checksum/versions" do
      ...
      expect(constants.length).to be == 77
      ...
      expect(Utility::Scenario.checksum("008")).to be == "1.0-8ef18a3a15f8692be9ea29896f359366"
      ...
      expect(Utility::Scenario.checksum("104")).to be == "0.2a-e3631f40e7823f6f85a0bd0f5651e5f1"
      expect(Utility::Scenario.checksum("105")).to be == "0.2a-64b91c9c6b28fc4d9c126d9248fd353c"
      expect(Utility::Scenario.checksum("106")).to be == "0.3b-c2f00e711c0164fa2b97a9468cc61ec4"
      ...
      expect(Utility::Scenario.checksum("111")).to be == "0.1p-74749b59053f8e0dccd7035f94b82844"
      expect(Utility::Scenario.checksum("112")).to be == "0.1p-0adb2aea626b418a137b88a805cfd9b3"
      ...
      expect(Utility::Scenario.checksum("207")).to be == "0.1p-9da7ee5a3fbfd0f440e003395837096d"
      ...
      expect(Utility::Scenario.checksum("401")).to be == "1.3-432cccf7e417c94713142ae49054cc7d"
      ...
      expect(Utility::Scenario.checksum("406")).to be == "0.5b-7df1dc005dc3d2f3a66dcde7cd5228cd"
      ...
      expect(Utility::Scenario.checksum("502")).to be == "0.2a-f661b4c5ca45abb9abacd6a4bbfa683f"
      ...
      expect(Utility::Scenario.checksum("509")).to be == "0.3a-b37c4dfbc4f94555badf6ca48b87435e"
      ...
      expect(Utility::Scenario.checksum("512")).to be == "0.3b-e44cf1925dbaa182d3b1d0df1c3c7153"
      ...
      expect(Utility::Scenario.checksum("604")).to be == "0.4b-1ec9617465607800e466485791e22844"
