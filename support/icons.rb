...
File.open('chg.svg', 'w') do |file|
  file.puts header
  factor = 0.8
  outside = 40 * factor
  outside_in = 38 * factor
  inside = 20 * factor
  inside_in = 19 * factor
  inside_out = 22 * factor
  write_circle(50, 50, 40, file, true, "#D00")
  write_circle(50, 50, outside, file, true, "#007")
  path = []
  0.upto(12) do |n|
    x = Math.sin(n * 30.0 / 180 * Math::PI) * outside_in + 50
    y = Math.cos(n * 30.0 / 180 * Math::PI) * outside_in + 50
    path.push([n == 0 ? "M" : "L", x, y])
    x = Math.sin((n + 0.5) * 30.0 / 180 * Math::PI) * inside + 50
    y = Math.cos((n + 0.5) * 30.0 / 180 * Math::PI) * inside + 50
    path.push(["L", x, y])
  end
  write_path(path, file, true, 3, "#FFF")
  write_circle(50, 50, inside_out, file, true, "#007")
  write_circle(50, 50, inside_in, file, true, "#FFF")
  file.puts footer
end
...
File.open('chc.svg', 'w') do |file|
  file.puts header
  # write_circle(50, 50, 42, file, true, "#FF0")
  path = []
  0.upto(6) do |n|
    x = Math.sin(n * 144.0 / 180 * Math::PI) * -40 + 50
    y = Math.cos(n * 144.0 / 180 * Math::PI) * -40 + 50
  ...
  write_path(path, file, false, 4, "#FF0")
  path = []
  0.upto(6) do |n|
...
File.open('vie.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 42, file, true, "#D00")
  path = []
  0.upto(6) do |n|
    x = Math.sin(n * 72.0 / 180 * Math::PI) * -35 + 50
    y = Math.cos(n * 72.0 / 180 * Math::PI) * -35 + 50
    path.push([n == 0 ? "M" : "L", x, y])
    x = Math.sin((36.0 + n * 72.0) / 180 * Math::PI) * -17.5 + 50
    y = Math.cos((36.0 + n * 72.0) / 180 * Math::PI) * -17.5 + 50
    path.push([n == 0 ? "M" : "L", x, y])
  end
...
File.open('chb.svg', 'w') do |file|
  file.puts header
  colors = [
    "#DE2119", "#FFC500", "#08639C", "#FFF", "#000"
  ]
  0.upto(4) do |n|
    path = []
    x = Math.sin(n * 72.0 / 180 * Math::PI) * -44 + 50
    y = Math.cos(n * 72.0 / 180 * Math::PI) * -44 + 52
    path.push(["M", x, y])
    x = Math.sin((36.0 + n * 72.0) / 180 * Math::PI) * -17 + 50
    y = Math.cos((36.0 + n * 72.0) / 180 * Math::PI) * -17 + 52
    path.push(["L", x, y])
    path.push(["L", 50, 50])
    x = Math.sin((-36.0 + n * 72.0) / 180 * Math::PI) * -17 + 50
    y = Math.cos((-36.0 + n * 72.0) / 180 * Math::PI) * -17 + 52
    path.push(["L", x, y])
    write_path(path, file, true, 1, colors[n])
  end
  0.upto(4) do |n|
    path = []
    x = Math.sin(n * 72.0 / 180 * Math::PI) * -44 + 50
    ...
    y = Math.cos(n * 72.0 / 180 * Math::PI) * -44 + 52
    path.push(["L", x, y])
    write_path(path, file, false, 2, "#000")
  end
  file.puts footer
end

File.open('nk.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 42, file, true, "#ED1C27")
  write_circle(50, 50, 37, file, true, "#FFF")
  write_circle(50, 50, 35, file, true, "#024fA2")
  write_circle(50, 50, 30, file, true, "#FFF")
  path = []
  0.upto(6) do |n|
    x = Math.sin(n * 144.0 / 180 * Math::PI) * -30 + 50
  ...
  write_path(path, file, true, 3, "#ED1C27")
  file.puts footer
end

File.open('rsp.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#C60B1E")
  write_circle(50, 50, 26.7, file, true, "#FFC400")
  write_circle(50, 50, 13.3, file, true, "#5D0080")
  file.puts footer
end

File.open('nsp.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#C60B1E")
  write_circle(50, 50, 26.7, file, true, "#FFC400")
  write_circle(50, 50, 8, file, true, "#C60B1E")
  file.puts footer
end

File.open('eth.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#006C3F")
  write_circle(50, 50, 32, file, true, "#FACE00")
  write_circle(50, 50, 24, file, true, "#D40000")
  path = []
  0.upto(3) do |n|
    x = Math.sin(n * 120.0 / 180 * Math::PI) * -24 + 50
    y = Math.cos(n * 120.0 / 180 * Math::PI) * -24 + 50
    path.push([n == 0 ? "M" : "L", x, y])
    x = Math.sin((60 + n * 120.0) / 180 * Math::PI) * -8 + 50
    y = Math.cos((60 + n * 120.0) / 180 * Math::PI) * -8 + 50
    path.push(["L", x, y])
  end
  write_path(path, file, true, 3, "#FACE00")
  path = []
  0.upto(3) do |n|
    x = Math.sin(n * 120.0 / 180 * Math::PI) * -6 + 50
    y = Math.cos(n * 120.0 / 180 * Math::PI) * -6 + 50
    path.push([n == 0 ? "M" : "L", x, y])
    x = Math.sin((60 + n * 120.0) / 180 * Math::PI) * -18 + 50
    y = Math.cos((60 + n * 120.0) / 180 * Math::PI) * -18 + 50
    path.push(["L", x, y])
  end
  write_path(path, file, true, 3, "#FACE00")
  file.puts footer
...
File.open('par.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#D52B1E")
  write_circle(50, 50, 26.7, file, true, "#FFF")
  write_circle(50, 50, 13.3, file, true, "#0038A8")
  file.puts footer
end

File.open('bol.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#D52B1E")
  write_circle(50, 50, 26.7, file, true, "#f9E300")
  write_circle(50, 50, 13.3, file, true, "#007934")
  file.puts footer
end

File.open('chb2.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#DE2119")
  write_circle(50, 50, 32, file, true, "#FFC500")
  write_circle(50, 50, 24, file, true, "#08639C")
  write_circle(50, 50, 16, file, true, "#fff")
  write_circle(50, 50, 8, file, true, "#000")
  file.puts footer
end

File.open('doi.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#F15B25")
  write_circle(50, 50, 26.7, file, true, "#FFF")
  write_circle(50, 50, 13.3, file, true, "#006934")
  file.puts footer
end

File.open('pak.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#01411c")
  write_circle(50, 50, 20, file, true, "#FFF")
  file.puts footer
end

File.open('syr.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#007A3D")
  write_circle(50, 50, 26.7, file, true, "#FFF")
  write_circle(50, 50, 13.3, file, true, "#000")
  0.upto(2) do |i|
    path = []
    0.upto(6) do |n|
      x = Math.sin(n * 144.0 / 180 * Math::PI) * -6 + 50 + Math.sin(i * 120.0 / 180 * Math::PI) * 19.5
      y = Math.cos(n * 144.0 / 180 * Math::PI) * -6 + 50 - Math.cos(i * 120.0 / 180 * Math::PI) * 19.5
      path.push([n == 0 ? "M" : "L", x, y])
    end
    write_path(path, file, true, 2, "#CE1126")
  end
  file.puts footer
end

File.open('jor.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#000")
  write_circle(50, 50, 26.7, file, true, "#FFF")
  write_circle(50, 50, 13.3, file, true, "#008D46")
  write_path([
    ["M", 50, 50],
    ["L", Math.sin(135.0 / 180 * Math::PI) * 40 + 50, Math.cos(135.0 / 180 * Math::PI) * 40 + 50],
    ["A", [40, 40], 90, [0, 0],
     [Math.sin(225.0 / 180 * Math::PI) * 40 + 50, Math.cos(225.0 / 180 * Math::PI) * 40 + 50]],
    ["L", 50, 50],
  ], file, true, 2, "#CE1126")
  path = []
  0.upto(8) do |n|
    x = Math.sin(n * 51.4286 / 180 * Math::PI) * -10 + 50
    y = Math.cos(n * 51.4286 / 180 * Math::PI) * -10 + 26
    path.push([n == 0 ? "M" : "L", x, y])
    x = Math.sin((21.7143 + n * 51.4286) / 180 * Math::PI) * -5 + 50
    y = Math.cos((21.7143 + n * 51.4286) / 180 * Math::PI) * -5 + 26
    path.push([n == 0 ? "M" : "L", x, y])
  end
  write_path(path, file, true, 2, "#FFF")
  file.puts footer
...
File.open('egy.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#00672B")
  write_circle(50, 50, 26.7, file, true, "#FFF")
  write_circle(50, 50, 13.3, file, true, "#00672B")
  write_circle(50, 50, 10, file, true, "#FFF")
  write_circle(52, 50, 8.5, file, true, "#00672B")
  path = []
  0.upto(6) do |n|
    x = Math.sin(n * 144.0 / 180 * Math::PI) * -2.5 + 50
    y = Math.cos(n * 144.0 / 180 * Math::PI) * -2.5 + 45.5
    path.push([n == 0 ? "M" : "L", x, y])
  end
  write_path(path, file, true, 1, "#FFF")
  path = []
  0.upto(6) do |n|
    x = Math.sin(n * 144.0 / 180 * Math::PI) * -2.5 + 50
    y = Math.cos(n * 144.0 / 180 * Math::PI) * 2.5 + 54.5
    path.push([n == 0 ? "M" : "L", x, y])
  end
  write_path(path, file, true, 1, "#FFF")
  path = []
  0.upto(6) do |n|
    y = Math.sin(n * 144.0 / 180 * Math::PI) * -2.5 + 50
    x = Math.cos(n * 144.0 / 180 * Math::PI) * 2.5 + 57.25
    path.push([n == 0 ? "M" : "L", x, y])
  end
  write_path(path, file, true, 1, "#FFF")
  file.puts footer
...
File.open('isr.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#FFF")
  path = []
  0.upto(6) do |n|
    x = Math.sin(n * 120.0 / 180 * Math::PI) * -30 + 50
    y = Math.cos(n * 120.0 / 180 * Math::PI) * -30 + 50
    path.push([n == 0 ? "M" : "L", x, y])
  end
  write_path(path, file, false, 5.5, "#29499D")
  path = []
  0.upto(6) do |n|
    x = Math.sin((180 + n * 120.0) / 180 * Math::PI) * -30 + 50
    y = Math.cos((180 + n * 120.0) / 180 * Math::PI) * -30 + 50
    path.push([n == 0 ? "M" : "L", x, y])
  end
  write_path(path, file, false, 5.5, "#29499D")
  file.puts footer
...
File.open('sk.svg', 'w') do |file|
  file.puts header
  write_path([
    ["M", 50, 50],
    ["A", [10.5, 10.5], 180, [0, 1],
     [-Math.sin(135.0 / 180 * Math::PI) * 42 + 50, Math.cos(125.0 / 180 * Math::PI) * 42 + 50]],
    ["A", [21, 21], 180, [0, 1],
     [Math.sin(135.0 / 180 * Math::PI) * 42 + 50, -Math.cos(125.0 / 180 * Math::PI) * 42 + 50]],
    ["A", [10.5, 10.5], 180, [0, 0], [50, 50]],
  ], file, true, 2, "#CD2E3A")
  write_path([
    ["M", 50, 50],
    ["A", [10.5, 10.5], 180, [0, 1],
...
File.open('cze.svg', 'w') do |file|
  file.puts header
  write_circle(50, 50, 40, file, true, "#333")
  write_circle(50, 50, 36, file, true, "#FFF")
  write_path([
    ["M", 50, 50],
    ["L", Math.sin(210.0 / 180 * Math::PI) * 36 + 50, Math.cos(210.0 / 180 * Math::PI) * 36 + 50],
    ["A", [36, 36], 90, [0, 0],
     [Math.sin(330.0 / 180 * Math::PI) * 36 + 50, Math.cos(330.0 / 180 * Math::PI) * 36 + 50]],
    ["L", 50, 50],
  ], file, true, 2, "#11457E")
  write_path([
    ["M", 50, 50],
    ["L", Math.sin(330.0 / 180 * Math::PI) * 36 + 50, Math.cos(330.0 / 180 * Math::PI) * 36 + 50],
    ["A", [36, 36], 90, [0, 0],
     [Math.sin(450.0 / 180 * Math::PI) * 36 + 50, Math.cos(450.0 / 180 * Math::PI) * 36 + 50]],
    ["L", 50, 50],
  ], file, true, 2, "#D7141A")
  file.puts footer
end

File.open('un.svg', 'w') do |file|
  file.puts <<EOF
<svg viewBox="0 0 470 400" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#FFF">
<circle cx="235" cy="200" r="204" fill="#07B"/>
<g transform="scale(0.8) translate(58.75 58.75)">
...
<g id="grid" stroke="#FFF" stroke-width="4" fill="none">
